...
- **CA LLC tax (Nomadic Light LLC) — leaning toward dissolving, one question open:** 2025 return (TFX/Lidiya Bridges) shows $0 federal tax owed — full $34,218 Schedule C profit excluded via FEIE (physical presence test, PT tax home since 06/29/2019); no SE tax either (US–Portugal totalization agreement). California Form 568 shows 0.00000% CA apportionment ("no business activity conducted in CA, services performed from Portugal") but still owes the flat **$800/yr minimum LLC franchise tax regardless of income/nexus** — 2025 already due (FTB 3588), **2026's $800 is due April 15, 2026** (FTB 3522, non-negotiable timing, paid in advance not after the fact) unless dissolved first.
  Lidiya's guidance so far: she personally wouldn't keep an LLC at this income level unless a client requires it or it disrupts banking/payments — check both before deciding. Dissolving is a legal, not tax, change — no partial-year fee, no effect on FEIE/totalization treatment either way (sole prop is taxed identically). Practical snag: if the EIN is registered to "Nomadic Light LLC" (not just "Nomadic Light"), a new EIN is likely needed post-dissolution — Spencer needs to check the EIN letter; can also just operate under his SSN. Open question sent back to her: what liability protection does he actually give up by dropping the LLC, given the nature of VO/audio work — her answer still pending, track it.
