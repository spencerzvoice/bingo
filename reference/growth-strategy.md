...
| **Linear** | **Julian Lehr** | Creative Director / storytelling lead — owns creative vision for releases (Spencer ✅) | julian@linear.app ✅ | **Ari Mojdeh** ✅ currently on Linear's team (linear.app/about, opened) — "Filmmaker, Brand and Product Storytelling" (title 🟡 RocketReach). Ex-Serious People (EP/Director), ex-The Pool Collective. Hands-on filmmaker w/ agency EP background — arguably the better *first* contact — ari@linear.app ✅ | ❓ Spencer to check |
...
1. **LinkedIn profile contents** — login wall. Bingo's WebSearch index also lags live Google (missed Madison Fenton's current "Brand Producer · Figma" line, missed Ari Mojdeh entirely). Mitigation: when the index comes up short, pivot to a primary source Bingo *can* open (company about/team page, personal site) OR ask Spencer to paste the Google snippet. All Funnel A roles now resolved as of 2026-08-30.
