...
| **Figma** | **Sydney Halle** | ✅ "Brand Producer at Figma" (LinkedIn headline) / "Brand Studio Producer" (ZoomInfo) — ex-Instrument (EP→Sr Producer→Producer: Marriott, Salesforce, Levi's, Instagram), also does motion design in Brand Studio | shalle@figma.com ✅ | Madison Fenton ❓ **could not confirm — no LinkedIn profile places her at Figma** (the Madison Fentons on LinkedIn are at Bechtel / Square). Apollo data may be stale or wrong name — Spencer verify before using · mfenton@figma.com ⚠️verify | ❓ Spencer to check |
...
1. **LinkedIn profile contents** — login wall. Search gives headlines + aggregator data, not tenure or reporting lines. Still open: **Madison Fenton** (confirm she's at Figma at all — no profile places her there). (Ari Mojdeh resolved 2026-08-30: confirmed on linear.app/about.)
