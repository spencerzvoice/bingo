...
1. **Webflow — Marc Andrews.** Near-daily video output, narration is inconsistent in-house. Clearest structural need. Lead the funnel here.
2. **Notion — Cory Zapatka.** Already buys pro VO for ad-type spots. Easiest yes; just needs to know Spencer exists.
3. **Framer — Andy Orsow.** Confirmed pro VO on paid-ad + product videos. "Consistent voice across your video types" now stands up.
4. **Miro — Samuel Rollier.** Mostly AI, but still hires real VO for product-tier pieces ("Product Acceleration"). Pitch that tier only.
5. **Figma — Sydney Halle.** Showcase/brand content (not tutorials) could take a voice. Softer need.
