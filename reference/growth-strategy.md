...
- **Asana** (Apollo, 2026-08-31). No "video" titles — video runs through creative producers here. **PRIMARY: Aubrey R. — Head of Creative Production & Operations** (SF; "AI Council Member" — keep AI debate off the table). **SECONDARY: Kyle O. or Beryl B. — Sr. Creative Producer** (pick whichever LinkedIn shows video work, not both). Alternate: Elaine C. — Creative Director. Skip: Maddy L. ("Genius Wrangler"), Tara V. (Head of Creative Operations — process/budget only).
